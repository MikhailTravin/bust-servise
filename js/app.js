...
const swiperAccount = new Swiper('.account__slider', {
	spaceBetween: 10,
	autoHeight: false,
	speed: 400,
	loop: false,
	slidesPerView: 1,
	navigation: {
		nextEl: '.account__arrow-next',
		prevEl: '.account__arrow-prev',
	},
	breakpoints: {
		320: {
			slidesPerView: 1,
...
//RANGE
const priceSliderTwo = document.querySelector('.calculate__rating-two');
if (priceSliderTwo) {

	let textFrom = priceSliderTwo.getAttribute('data-from');
	let textTo = priceSliderTwo.getAttribute('data-to');
	...
	*/
	...
	function setPriceValues() {
		...
		priceSliderTwo.noUiSlider.set([priceStartValue, priceEndValue]);
	}
}
